...
elemento Element(pila *s, int n);				//FUNCION NUEVA RETORNA ELEMENTO N INGRESADO
void Flip(pila *s);								//FUNCION NUEVA DE FLIP PARA INVERTIR PILA
void Menu();									//FUNCION NUEVA DE MENU